...
public class SBCardPopupViewController: UIViewController {
    ...
    public func show(onViewController viewController: UITabBarController) {
        self.modalPresentationStyle = .overCurrentContext
        viewController.present(self, animated: false, completion: nil)
    }
    ...
    override public func viewDidLoad() {
        ...
        // Apply Constraints
        applyCustomContainerViewConstraints() // applyContainerViewConstraints()
    ...
    private func applyCustomContainerViewConstraints() {
