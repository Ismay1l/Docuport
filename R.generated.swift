...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    /// Resource file `Updates.json`.
    static let updatesJson = Rswift.FileResource(bundle: R.hostingBundle, name: "Updates", pathExtension: "json")
    ...
    /// `bundle.url(forResource: "Updates", withExtension: "json")`
    static func updatesJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.updatesJson
      return fileResource.bundle.url(forResource: fileResource)
    }
  ...
  struct image {
    /// Image `account_business_selected`.
    static let account_business_selected = Rswift.ImageResource(bundle: R.hostingBundle, name: "account_business_selected")
    /// Image `account_business`.
    static let account_business = Rswift.ImageResource(bundle: R.hostingBundle, name: "account_business")
    /// Image `account_personal_selected`.
    static let account_personal_selected = Rswift.ImageResource(bundle: R.hostingBundle, name: "account_personal_selected")
    /// Image `account_personal`.
    static let account_personal = Rswift.ImageResource(bundle: R.hostingBundle, name: "account_personal")
    /// Image `account`.
    ...
    /// Image `payroll_arrow_ic`.
    static let payroll_arrow_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_arrow_ic")
    /// Image `payroll_check_ic`.
    static let payroll_check_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_check_ic")
    /// Image `payroll_complete_ic`.
    static let payroll_complete_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_complete_ic")
    /// Image `payroll_delete_ic`.
    static let payroll_delete_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_delete_ic")
    /// Image `payroll_draft_ic`.
    static let payroll_draft_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_draft_ic")
    /// Image `payroll_tabBar_ic`.
    static let payroll_tabBar_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_tabBar_ic")
    /// Image `payroll_tabBar_selected_ic`.
    static let payroll_tabBar_selected_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_tabBar_selected_ic")
    /// Image `payroll_uncheck_ic`.
    static let payroll_uncheck_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payroll_uncheck_ic")
    /// Image `payrollcell_delete_dis_ic`.
    static let payrollcell_delete_dis_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payrollcell_delete_dis_ic")
    /// Image `payrollcell_delete_ic`.
    static let payrollcell_delete_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payrollcell_delete_ic")
    /// Image `payrollcell_edit_dis_ic`.
    static let payrollcell_edit_dis_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payrollcell_edit_dis_ic")
    /// Image `payrollcell_edit_ic`.
    static let payrollcell_edit_ic = Rswift.ImageResource(bundle: R.hostingBundle, name: "payrollcell_edit_ic")
    /// Image `pdf`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "account_business", bundle: ..., traitCollection: ...)`
    static func account_business(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.account_business, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "account_business_selected", bundle: ..., traitCollection: ...)`
    static func account_business_selected(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.account_business_selected, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "account_personal", bundle: ..., traitCollection: ...)`
    static func account_personal(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.account_personal, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "account_personal_selected", bundle: ..., traitCollection: ...)`
    static func account_personal_selected(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.account_personal_selected, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_arrow_ic", bundle: ..., traitCollection: ...)`
    static func payroll_arrow_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_arrow_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_check_ic", bundle: ..., traitCollection: ...)`
    static func payroll_check_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_check_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_complete_ic", bundle: ..., traitCollection: ...)`
    static func payroll_complete_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_complete_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_delete_ic", bundle: ..., traitCollection: ...)`
    static func payroll_delete_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_delete_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_draft_ic", bundle: ..., traitCollection: ...)`
    static func payroll_draft_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_draft_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_tabBar_ic", bundle: ..., traitCollection: ...)`
    static func payroll_tabBar_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_tabBar_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_tabBar_selected_ic", bundle: ..., traitCollection: ...)`
    static func payroll_tabBar_selected_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_tabBar_selected_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payroll_uncheck_ic", bundle: ..., traitCollection: ...)`
    static func payroll_uncheck_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payroll_uncheck_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payrollcell_delete_dis_ic", bundle: ..., traitCollection: ...)`
    static func payrollcell_delete_dis_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payrollcell_delete_dis_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payrollcell_delete_ic", bundle: ..., traitCollection: ...)`
    static func payrollcell_delete_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payrollcell_delete_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payrollcell_edit_dis_ic", bundle: ..., traitCollection: ...)`
    static func payrollcell_edit_dis_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payrollcell_edit_dis_ic, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "payrollcell_edit_ic", bundle: ..., traitCollection: ...)`
    static func payrollcell_edit_ic(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.payrollcell_edit_ic, compatibleWith: traitCollection)
    }
    #endif
  ...
  struct nib {
    /// Nib `AddEmployeeView`.
    static let addEmployeeView = _R.nib._AddEmployeeView()
    /// Nib `CommentView`.
    static let commentView = _R.nib._CommentView()
    /// Nib `DeleteEmployeeView`.
    static let deleteEmployeeView = _R.nib._DeleteEmployeeView()
    /// Nib `DraftView`.
    static let draftView = _R.nib._DraftView()
    /// Nib `MissionCompleteView`.
    static let missionCompleteView = _R.nib._MissionCompleteView()

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "AddEmployeeView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.addEmployeeView) instead")
    static func addEmployeeView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.addEmployeeView)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "CommentView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.commentView) instead")
    static func commentView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.commentView)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "DeleteEmployeeView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.deleteEmployeeView) instead")
    static func deleteEmployeeView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.deleteEmployeeView)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "DraftView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.draftView) instead")
    static func draftView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.draftView)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UINib(name: "MissionCompleteView", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.missionCompleteView) instead")
    static func missionCompleteView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.missionCompleteView)
    }
    #endif

    static func addEmployeeView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.addEmployeeView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }

    static func commentView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.commentView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }

    static func deleteEmployeeView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.deleteEmployeeView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }

    static func draftView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.draftView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }

    static func missionCompleteView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.missionCompleteView.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }
  ...
  struct reuseIdentifier {
    ...
    /// Reuse identifier `UploadTagsCell`.
    static let uploadTagsCell: Rswift.ReuseIdentifier<UploadTagsCell> = Rswift.ReuseIdentifier(identifier: "UploadTagsCell")
    /// Reuse identifier `payrollCell`.
    static let payrollCell: Rswift.ReuseIdentifier<PayrollCell> = Rswift.ReuseIdentifier(identifier: "payrollCell")
    /// Reuse identifier `payrollInfoCell`.
    static let payrollInfoCell: Rswift.ReuseIdentifier<PayrollInfoCell> = Rswift.ReuseIdentifier(identifier: "payrollInfoCell")
  ...
  struct string {
    ...
    struct localizable {
      /// Value: Maybe later
      static let updatesCancelButtonTitle = Rswift.StringResource(key: "updates.cancel-button-title", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: OK
      static let updatesUpdateButtonTitle = Rswift.StringResource(key: "updates.update-button-title", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)

      /// Value: Maybe later
      static func updatesCancelButtonTitle(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("updates.cancel-button-title", bundle: hostingBundle, comment: "")
        }

        guard let (_, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "updates.cancel-button-title"
        }

        return NSLocalizedString("updates.cancel-button-title", bundle: bundle, comment: "")
      }

      /// Value: OK
      static func updatesUpdateButtonTitle(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("updates.update-button-title", bundle: hostingBundle, comment: "")
        }

        guard let (_, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "updates.update-button-title"
        }

        return NSLocalizedString("updates.update-button-title", bundle: bundle, comment: "")
      }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    static func validate() throws {
      try _DeleteEmployeeView.validate()
      try _DraftView.validate()
      try _MissionCompleteView.validate()
    }

    struct _AddEmployeeView: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "AddEmployeeView"
    ...
    struct _CommentView: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "CommentView"
    ...
    struct _DeleteEmployeeView: Rswift.NibResourceType, Rswift.Validatable {
      let bundle = R.hostingBundle
      let name = "DeleteEmployeeView"
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "payroll_delete_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_delete_ic' is used in nib 'DeleteEmployeeView', but couldn't be loaded.") }
    ...
    struct _DraftView: Rswift.NibResourceType, Rswift.Validatable {
      let bundle = R.hostingBundle
      let name = "DraftView"
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "payroll_draft_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_draft_ic' is used in nib 'DraftView', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct _MissionCompleteView: Rswift.NibResourceType, Rswift.Validatable {
      let bundle = R.hostingBundle
      let name = "MissionCompleteView"
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "payroll_complete_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_complete_ic' is used in nib 'MissionCompleteView', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct advisor: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let advisorTabBarController = StoryboardViewControllerResource<AdvisorTabBarController>(identifier: "AdvisorTabBarController")
      let bundle = R.hostingBundle
      ...
      let name = "Advisor"
      let payrollVC = StoryboardViewControllerResource<PayrollViewController>(identifier: "PayrollVC")
      ...
      func advisorTabBarController(_: Void = ()) -> AdvisorTabBarController? {
      ...
      func payrollVC(_: Void = ()) -> PayrollViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: payrollVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "btnShare", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'btnShare' is used in storyboard 'Advisor', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "buttonSearch", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'buttonSearch' is used in storyboard 'Advisor', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "docPhoto", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'docPhoto' is used in storyboard 'Advisor', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "logout_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'logout_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "payroll_check_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_check_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payroll_tabBar_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_tabBar_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payroll_tabBar_selected_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_tabBar_selected_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payrollcell_delete_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payrollcell_delete_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payrollcell_edit_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payrollcell_edit_ic' is used in storyboard 'Advisor', but couldn't be loaded.") }
        ...
        if _R.storyboard.advisor().advisorTabBarController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'advisorTabBarController' could not be loaded from storyboard 'Advisor' as 'AdvisorTabBarController'.") }
        ...
        if _R.storyboard.advisor().payrollVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'payrollVC' could not be loaded from storyboard 'Advisor' as 'PayrollViewController'.") }
    ...
    struct client: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = HomeTabController

      let accountsVC = StoryboardViewControllerResource<AccountsVC>(identifier: "AccountsVC")
      let bundle = R.hostingBundle
      let clientTabBarController = StoryboardViewControllerResource<HomeTabController>(identifier: "ClientTabBarController")
      let clientUploadWrapperVC = StoryboardViewControllerResource<ClientUploadWrapperVC>(identifier: "ClientUploadWrapperVC")
      ...
      func clientTabBarController(_: Void = ()) -> HomeTabController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: clientTabBarController)
      }

      func clientUploadWrapperVC(_: Void = ()) -> ClientUploadWrapperVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: clientUploadWrapperVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "btnShare", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'btnShare' is used in storyboard 'Client', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "buttonSearch", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'buttonSearch' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "docPhoto", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'docPhoto' is used in storyboard 'Client', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "logout_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'logout_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payroll_check_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_check_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payroll_tabBar_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_tabBar_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payroll_tabBar_selected_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payroll_tabBar_selected_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payrollcell_delete_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payrollcell_delete_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        if UIKit.UIImage(named: "payrollcell_edit_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'payrollcell_edit_ic' is used in storyboard 'Client', but couldn't be loaded.") }
        ...
        if _R.storyboard.client().clientTabBarController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'clientTabBarController' could not be loaded from storyboard 'Client' as 'HomeTabController'.") }
        if _R.storyboard.client().clientUploadWrapperVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'clientUploadWrapperVC' could not be loaded from storyboard 'Client' as 'ClientUploadWrapperVC'.") }
        ...
        if _R.storyboard.client().payrollVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'payrollVC' could not be loaded from storyboard 'Client' as 'PayrollViewController'.") }
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let tagsVC = StoryboardViewControllerResource<TagsVC>(identifier: "TagsVC")
      let uploadTagsVC = StoryboardViewControllerResource<UploadTagsVC>(identifier: "UploadTagsVC")
      ...
      func tagsVC(_: Void = ()) -> TagsVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: tagsVC)
      }

      func uploadTagsVC(_: Void = ()) -> UploadTagsVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: uploadTagsVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "arrowRight", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'arrowRight' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "imageView:7NB-0c-B2m:image", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'imageView:7NB-0c-B2m:image' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "logout_ic", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'logout_ic' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if _R.storyboard.main().tagsVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'tagsVC' could not be loaded from storyboard 'Main' as 'TagsVC'.") }
        if _R.storyboard.main().uploadTagsVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'uploadTagsVC' could not be loaded from storyboard 'Main' as 'UploadTagsVC'.") }
